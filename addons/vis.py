...
from . import triplets_utils  as tu
...
def vis_embed(src_model, tgt_model, src_loader, tgt_loader_eval):
    X,_ = tu.extract_embeddings(src_model, src_loader)
    
    Y,_ = tu.extract_embeddings(tgt_model, tgt_loader_eval)
...
def visEmbed(exp_dict):
    ...
    X,X_tgt = tu.extract_embeddings(src_model, src_loader)
    
    Y,Y_tgt = tu.extract_embeddings(tgt_model, tgt_val_loader)
